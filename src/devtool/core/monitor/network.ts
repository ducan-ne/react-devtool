...
export const flush = async (): Promise<void> => {
  ...
  const pendingInteractions: InternalInteraction[] = [];
  const completedInteractions: InternalInteraction[] = [];
  ...
  const aggregatedComponents: Component[] = [];
  const aggregatedInteractions: Interaction[] = [];
